...
Not yet populated. Lands with Foundation issue F-5: `requirements.yaml` (one entry per
`FR-nn`/`NFR-nn` from the PRD, extracted once and then hand-maintained), the
