...
parsing and Verhoeff check-digit validation (FR-06) and the terminology client
contract (FR-53) are written once, here, and imported by both ``backend`` and
...
The SCTID/Verhoeff library lands with backlog issue P0-10.
"""
